<?php
    ...
    // Fetch hostel due details
    $query = mysqli_query($connection, "SELECT * FROM hostel_due WHERE grn='" . $_SESSION['grn'] . "'");
...
<head>
    ...
    <title><?php echo $_SESSION['name']; ?> - Hostel Due</title>
